    ...
    <div>
      ...
      <div id="internship-title">
        ...
        <svg
          ...
          class="svg-inline--fa fa-plus-square fa-w-14 plus-icon"
          role="img"
              ...
              <LocalForm className="internship-form">
                <Row>
                  <Label
                    htmlFor="semester"
                    lg={3}
                    className="internship-form-label"
                  >
                ...
                <Row className="submit-button-internship">
                  ...
                  <Button type="submit" id="internship-save-button">
    ...
    return (
      <div>
        ...
        <div className="single-internship-form">
          <Form
            model="userInternships"
            onSubmit={(values) => this.handleInternships(values)}
          >
            <Row>
              <Label
                htmlFor="semester"
            ...
            <Row>
              <Label htmlFor="domain" lg={3} className="internship-form-label">
                Domain of Internship :*
              </Label>
              <Col className="internship-form-fields">
                <Control.text
            ...
            <Row>
              <Label htmlFor="stipend" lg={3} className="internship-form-label">
                Stipend (if paid) :
              </Label>
              <Col className="internship-form-fields">
                <Control.text
